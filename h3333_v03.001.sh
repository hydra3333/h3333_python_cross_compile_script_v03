...
cd ~/Desktop
rm -fv ./h3333_cross_compiler_v03.001.py
wget --content-disposition "https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v03/master/h3333_cross_compiler_v03.001.py"
...
cd ~/Desktop
sudo chmod 777 -R *
#./h3333_cross_compiler_v03.001.py --force --debug --products --dependencies -pl ffmpeg_static_non_free_opencl,x265_multibit
#./h3333_cross_compiler_v03.001.py --force --debug -p x265_multibit
# only use --force if ity's already been fully built, 
# or it breaks if you use it the first time
./h3333_cross_compiler_v03.001.py list -p 2>&1 | tee -a ./0.debug.log
./h3333_cross_compiler_v03.001.py list -d 2>&1 | tee -a ./0.debug.log
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p ffmpeg_static_non_free 2>&1 | tee -a ./0.debug.log
exit_status=$?
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p ffmpeg_static_non_free_opencl 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p x264 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p x265_multibit 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p mp4box 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p lame 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p aom 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p sox 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p vpx 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p mediainfo 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p dav1d 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./0.debug.log
echo "# `date` ###################################################################################" >>./0.debug.log
./h3333_cross_compiler_v03.001.py --force --debug -p fftw3_dll 2>&1 | tee -a ./0.debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
#echo "# `date` ###################################################################################" >>./0.debug.log
#echo "# `date` ###################################################################################" >>./0.debug.log
#./h3333_cross_compiler_v03.001.py --force --debug -p lameENC_DLL 2>&1 | tee -a ./0.debug.log
#exit_status=$?
#echo "exit_status='$exit_status'"
#if [ $exit_status -ne 0 ]; then
#    echo "Error $exit_status detected"
...
#./h3333_cross_compiler_v03.001.py -p mkvtoolnix
#exit_status=$?
#echo "exit_status='$exit_status'"
#if [ $exit_status -ne 0 ]; then
#    echo "Error $exit_status detected"
