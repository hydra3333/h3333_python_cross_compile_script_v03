...
echo "# `date` ###################################################################################" >>./0.debug-x264.029.log
echo "# `date` ###################################################################################" >>./0.debug-x264.029.log
./h3333_cross_compiler_v03.001.py --force --debug -d libx264 2>&1 | tee -a ./0.debug-x264.029.log
read -p "After build libx264, press Enter to continue"
./h3333_cross_compiler_v03.001.py --force --debug -p x264 2>&1 | tee -a ./0.debug-x264.029.log
exit_status=$?
